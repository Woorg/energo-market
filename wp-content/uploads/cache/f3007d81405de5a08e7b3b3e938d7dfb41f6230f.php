...
<div class="footer">
  <div class="container-fluid">
    <p class="footer__copyright"><?php echo e(date('Y')); ?> <?php echo $copyright; ?></p>
    ...
    <?php if($created): ?>
      ...
      ?>
      <a class="footer__dev-link" href="<?php echo e($created_link); ?>" target="_blank">
        <img src="<?php echo $created_image['sizes']['large']; ?>" alt="<?php echo $created_image['alt']; ?>">
      </a>
     <?php endif; ?>
    </p>
  </div>
...
<div class="fancybox-is-hidden" id="popup-request">
  <div class="popup">
    ...
    <div class="popup__content">
      <?php if($form_title_1): ?>
        <span class="popup__title"><?php echo e($form_title_1); ?></span>
      <?php endif; ?>
